...
def class_central_scraper():
    ...
    class_central_url = "https://www.classcentral.com/search?q=web+development&free=true"
        ...
        for course in ccourses:
            try:
                ...
                c.execute('''
                    ...
                    VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
                ''', ('Web Development', title, creator, description, platform, duration, '', likes, published_on, link, thumbnail, 'Course', ''))
